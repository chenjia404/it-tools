...
const booleanFromEnv = z.union([z.boolean(), z.string()]).transform(value => value === true || value === 'true');

const appEnvSchema = z.enum(['production', 'development', 'preview', 'test']);
